...
*/    
    ...
    {   
        ...
        {
            if($this->NumPage > 10)
                $menu .= $this->createLink(($this->NumPage - 10), '-10', '');
...
*/      
    ...
    {                   
        ...
        if($active)
            return "<li>"
                 . "<a href=\"". href($this->LevelPage .'='. $page) ."\" />". $link ."</a></li>\n";
        else

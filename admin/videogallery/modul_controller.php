...
define('DBNAME',   'videogallery');	
define('PTITLE',   'Fotogalerie');	
define('ETITLE',   'Pagina de editare');
define('ADDNEW',   'Adaugă o galerie');	

define('INSERT_ROTITLE',   'Introduceţi denumirea Video in limba Romană');
define('INSERT_RUTITLE',   'Introduceţi denumirea Video in limba Rusă');
define('INSERT_ENTITLE',   'Introduceţi denumirea Video in limba Engleză');

define('INSERT_CONTENT',   'Introduceţi Link-ul video sau URL-ul de pe Youtube');
...
*/    
    if($GET['rem'] == 'edit')
    {
        ...
        {  mysqlQuery("UPDATE " . DBNAME . "
                      ...
                      `video`   ='". escapeString($POST['value4']) ."'
...
*/
        ...
        if (mysql_num_rows($res) > 0)
        {
            $row = mysql_fetch_assoc($res);
                 ...
                 $row['content']   = createBBtags($row['video']);

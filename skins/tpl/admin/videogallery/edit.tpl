...
<br />
<div class="inp">
<label><strong>Conţinutul paginii in limba romană <a target="_blank" href="<?php echo href('lang='. $GET['lang'],'page=filemanager'); ?>"><strong>Manager</strong></a></strong></strong></label>
